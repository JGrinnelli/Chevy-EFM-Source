...
//changed this for sdk test
Matrix333 quaternion_to_matrix(const Quaternion & v)
{
	Matrix333 mtrx;
...
double avg(double arg1, double weight1, double arg2, double weight2)
{
	return (arg1 * weight1 + arg2 * weight2);
}